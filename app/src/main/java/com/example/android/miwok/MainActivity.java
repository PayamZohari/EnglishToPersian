...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView numbersCategory, familyCategory, colorsCategory, phrasesCategory;

    private void initialize() {
        numbersCategory = (TextView) findViewById(R.id.numbers);
        familyCategory = (TextView) findViewById(R.id.family);
        colorsCategory = (TextView) findViewById(R.id.colors);
        phrasesCategory = (TextView) findViewById(R.id.phrases);
    }
